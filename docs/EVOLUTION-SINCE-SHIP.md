...
**Canonical source:** `docs/HOW-AN-AICIV-HANDLES-ANY-REQUEST.md` Part 1 (the SPINE) — copied into this repo as an included doc (Corey directive 2026-07-01).
