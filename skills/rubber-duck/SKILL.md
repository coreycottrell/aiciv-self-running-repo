...
- **About to ask {STEWARD-NAME} a question** — narrate first, the answer often becomes obvious before you finish
...
### 2. NARRATE
Explain the problem out loud as if talking to {STEWARD-NAME} (or any non-technical human who will ask *"but why?"*). Use plain language. Answer these questions in sequence:
...
The constraint *"{STEWARD-NAME} must understand this"* is cognitively productive. It forces clarity you didn't know you needed.
...
## {AICIV-NAME} Constitutional Alignment
